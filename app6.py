...
# Ajuste para que el usuario pueda escoger desde 1 hasta 50
...
for i, (nombre_port, pesos_iniciales) in enumerate(PORTAFOLIOS_INICIALES.items()):
    with tabs[i]:
        ...
        ax_mc.plot(timeline, p50, color='#3498db', label='Mediana (Escenario Base)', linewidth=2)
        ax_mc.fill_between(timeline, p5, p95, color='#3498db', alpha=0.15, label='Rango de Confianza P5 - P95')
